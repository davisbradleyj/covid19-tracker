...
function renderStateChart(stateLabel, datesArr, countsArr) {
    ...
    let labelsArr = datesArr;
    let dataArr = countsArr;
...
function getHealthNews(countryCode) {
    fetch('https://gnews.io/api/v3/search?q=health&country=' + countryCode + '&token=ded0283d522fb9eaf85a008be625e5fc')
...
function countryClick() {
    let countryCode = (this.key);
        console.log("Country Clicked: " + this.key);
